<?php
    ...
    $author_info = get_the_author_meta( 'lariv_write_by');
    $facebook_url = get_the_author_meta( 'lariv_facebook' );
    $twitter_url = get_the_author_meta( 'lariv_twitter' );
    $linkedin_url = get_the_author_meta( 'lariv_linkedin' );
    $instagram_url = get_the_author_meta( 'lariv_instagram' );
    $lariv_url = get_the_author_meta( 'lariv_youtube' );
    $lariv_write_by = get_the_author_meta( 'lariv_write_by' );
