...
$lariv_blog_date = get_theme_mod( 'lariv_blog_date', true );
$lariv_blog_comments = get_theme_mod( 'lariv_blog_comments', true );
$lariv_blog_author = get_theme_mod( 'lariv_blog_author', true );
$lariv_blog_cat = get_theme_mod( 'lariv_blog_cat', false );

?>


<div class="postbox__meta">
    <?php if ( !empty($lariv_blog_author) ): ?>
