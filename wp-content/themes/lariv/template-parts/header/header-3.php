<?php 
   ...
   $lariv_phone_num = get_theme_mod( 'lariv_phone_num', __( '+(088) 234 567 899', 'lariv' ) );
   $lariv_mail_id = get_theme_mod( 'lariv_mail_id', __( 'info@lariv.com', 'lariv' ) );
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-6 d-none d-lg-block">
                  <div class="header__call d-flex align-items-start">
                     ...
                     <div class="header__call-content">
                        <?php if ( !empty( $lariv_phone_num ) ): ?>   
                        <h4><a href="tel:<?php echo esc_attr($lariv_phone_num); ?>"><?php echo esc_html($lariv_phone_num); ?></a></h4>
                        <?php endif; ?> 
                        <?php if ( !empty( $lariv_mail_id ) ): ?>   
                        <p><a href="mailto:<?php echo esc_attr($lariv_mail_id); ?>"><?php echo esc_html($lariv_mail_id); ?></a></p>
                        <?php endif; ?> 
                     </div>
                  </div>
               </div>
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-8 col-6">
                  <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                     <div class="header__lang d-none d-md-block">
                        <?php lariv_header_lang_defualt(); ?>
                     </div>

                     <?php if ( !empty( $lariv_acc_button_link ) ): ?>
                     <div class="header__login-2 d-none d-md-flex align-items-center ml-20 pl-20">
                        ...
                        <div class="header__login-content">
                           <p><a href="<?php echo esc_html($lariv_acc_button_link); ?>"><?php echo esc_html__('Login','lariv'); ?></a></p>
                           <p><a href="<?php echo esc_html($lariv_acc_button_link); ?>"><?php echo esc_html__('Register','lariv'); ?></a></p>
                        </div>
                     </div>
                     <?php endif; ?>
   ...
   <div class="header__bottom">
      <div class="container">
         <div class="row align-items-center">
            ...
            <?php if ( !empty( $lariv_header_right ) ): ?>
            <div class="col-xxl-4 col-xl-3 col-lg-2 col-md-6 col-6">
               <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                  ...
                  <div class="header__action d-none d-xl-block">
                     <ul>
                        <li>
                           <a href="<?php echo esc_html($lariv_acc_button_link); ?>">
                  ...
                  <div class="header__search header__search-2 header__search-3 d-none d-xl-block">
                     <form action="<?php print esc_url( home_url( '/' ) );?>">
                        <div class="header__search-input">
                           <input type="text" name="s" value="<?php print esc_attr( get_search_query() )?>" placeholder="<?php print esc_attr__( 'Search...', 'lariv' );?>">
