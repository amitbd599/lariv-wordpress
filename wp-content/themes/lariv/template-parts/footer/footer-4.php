...
<footer>
    <div class="footer__area footer__black">
       ...
       <div class="footer__top black-bg-5 pt-95 pb-45" data-bg-color="<?php print esc_attr( $bg_color );?>" data-top-space="<?php print esc_attr($lariv_footer_top_space); ?>px"  data-background="<?php print esc_url( $bg_img );?>">
          <div class="container">
             <div class="row">
                <?php
                    if ( $footer_columns < 4 ) {
