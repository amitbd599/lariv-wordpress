...
$event_btn_text = get_theme_mod('event_btn_text', __('Enroll Now', 'lariv')); 
$event_btn_link = get_theme_mod('event_btn_link', __('#', 'lariv')); 
            ...
            <ul>
               ...
               ?>
                <li class="d-flex align-items-center">
                    ...
                    <div class="event__info-item">
                        <h5><span><?php echo esc_html__('End', 'lariv'); ?> :</span> <?php echo esc_html($data['event_end_date']); ?></h5>
                    </div>
                </li>
                <?php endif; ?>
               ...
               ?>
                <li class="d-flex align-items-center">
                    ...
                    <div class="event__info-item">
                        <h5><span><?php echo esc_html__('Time', 'lariv'); ?> :</span> <?php echo esc_html($data['event_start_time'] . $separate . $data['event_end_time']); ?></h5>
                    </div>
                </li>
                <?php endif; ?>
               ...
               ?>
                <li class="d-flex align-items-center">
                    ...
                    <div class="event__info-item">
                        <h5><span><?php echo esc_html__('Venue', 'lariv'); ?> :</span> <?php echo esc_html($data['etn_event_location']);  ?></h5>
                    </div>
                </li>
                <?php endif; ?>
